...
namespace LasGranjas.Editor
{
    ...
    public static class ZoneSelectionSceneBuilder
    {
        ...
        const string TempEventPrefabPath =
            "Assets/01_Scripts/ZoneSelection/Editor/Temp/_LasGranjas_EventSystemFromMainMenu.prefab";
        ...
        {
            const string tempRoot = "Assets/01_Scripts/ZoneSelection/Editor/Temp";
            if (AssetDatabase.IsValidFolder(tempRoot))
                return;
            if (!AssetDatabase.IsValidFolder("Assets/01_Scripts/ZoneSelection/Editor"))
            {
                if (!AssetDatabase.IsValidFolder("Assets/01_Scripts/ZoneSelection"))
                    AssetDatabase.CreateFolder("Assets/01_Scripts", "ZoneSelection");
                AssetDatabase.CreateFolder("Assets/01_Scripts/ZoneSelection", "Editor");
            }

            AssetDatabase.CreateFolder("Assets/01_Scripts/ZoneSelection/Editor", "Temp");
        }
