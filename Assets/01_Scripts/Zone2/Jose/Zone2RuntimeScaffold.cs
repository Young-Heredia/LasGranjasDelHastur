...
{
    /// <summary>
    /// Construye la jerarquía mínima de <c>Zone2_Cities</c> en Play Mode (equivalente al scaffold de editor).
    /// </summary>
    public static class Zone2RuntimeScaffold
    {
        ...
        {
            if (parent == null || !parent || parent.Find("SlotGuides") != null)
                return;
        ...
        {
            if (parent == null || !parent || parent.Find("CityFloorPlate") != null)
                return;
        ...
        {
            if (parent == null || !parent || parent.Find("CondensedSkyline_Back") != null)
                return;
        ...
        {
            if (parent == null || !parent || parent.Find("UrbanCellField") != null)
                return;
        ...
        {
            if (parent == null || !parent || parent.Find("UrbanDecor") != null)
                return;
        ...
        {
            if (parent == null || !parent || parent.Find("UrbanFog") != null)
                return;
        ...
        {
            if (parent == null || !parent || parent.Find("FrontRubble") != null)
                return;
        ...
        {
            if (parent == null || !parent || parent.Find("UrbanVignette") != null)
                return;
