...
namespace LasGranjasDelHastur.Zone2
{
    public static class Zone2RuntimeScaffold
    {
        ...
        static void EnsureWorldHierarchy()
        {
            ...
            CreateSpriteBlock(floor.transform, "CityFloorPlate", Sprite_Z2_Backplate, new Vector3(0f, 0f, 0f), new Vector3(26f, 16f, 1f), new Color(0.08f, 0.12f, 0.14f, 1f), 0);
            CreateSpriteBlock(back.transform, "CondensedSkyline_Back", Sprite_Z2_Backdrop, new Vector3(0f, 4.6f, 0f), new Vector3(22f, 5.5f, 1f), new Color(0.14f, 0.14f, 0.16f, 1f), -4);
            CreateSpriteBlock(cell.transform, "UrbanCellField", new Vector3(0f, -0.1f, 0f), new Vector3(15.5f, 9.8f, 1f), new Color(0.10f, 0.14f, 0.15f, 0.54f), 4);
            CreateSpriteBlock(decor.transform, "UrbanDecor", new Vector3(0f, -4.0f, 0f), new Vector3(8.6f, 2.2f, 1f), new Color(0.28f, 0.18f, 0.11f, 0.22f), 9);
            CreateSpriteBlock(fog.transform, "UrbanFog", Sprite_Z2_FogSheet, new Vector3(0f, -2.6f, 0f), new Vector3(20f, 5.2f, 1f), new Color(0.48f, 0.50f, 0.45f, 0.12f), 24);
            CreateSpriteBlock(front.transform, "FrontRubble", Sprite_Z2_FrontRubble, new Vector3(0f, -6.4f, 0f), new Vector3(24f, 2.0f, 1f), new Color(0.12f, 0.10f, 0.10f, 0.96f), 76);
            CreateSpriteBlock(atmo.transform, "UrbanVignette", new Vector3(0f, 0f, 0f), new Vector3(28f, 17f, 1f), new Color(0.03f, 0.04f, 0.06f, 0.22f), 88);
        }
