...
Contenido principal de `Assets/`: `00_Scenes`, `01_Scripts`, `02_Scripts`, `02_Sprites`, `03_AUDIO`, `04_Prefabs`, `05_Fonts` (detalle en el doc enlazado). En `01_Scripts` la convención es **dominio primero** (`Audio`, `Camera`, `Core`, `Intro`, `MainMenu`, `SceneManagement`, `UI`, `Zone1`…, `ZoneSelection`) y **dentro por persona** (`Edwin`, `Jose`, `Lucas`).
